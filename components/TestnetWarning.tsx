...
export function TestnetWarning() {
  ...
  return (
    <div className="fixed top-4 left-4 z-[99] flex items-center gap-2">
      {/* Email Icon */}
      <a
        href="mailto:forever@loscolmebrothers.com"
        className="glass-surface shadow-glass backdrop-blur-sm border border-cyan-400/40 bg-cyan-500/20 rounded-lg px-3 py-2 transition-all duration-300 hover:bg-cyan-500/30"
      >
        <p className="text-cyan-200 text-sm font-medium">✉️</p>
      </a>
      ...
      >
        ...
        >
          ...
          >
            {isExpanded ? "⚠️ Beta — Running on Base Sepolia" : "⚠️"}
          </p>
          {!isExpanded && (
