    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Subtle edge borders for spatial awareness */}
          <Layer listening={false}>
            {/* Top edge */}
            <Rect
              x={0}
            ...
            <Rect
              ...
              width={oceanWidth}
              height={100}
              fillLinearGradientStartPoint={{ x: 0, y: oceanHeight - 100 }}
              fillLinearGradientEndPoint={{ x: 0, y: oceanHeight }}
              fillLinearGradientColorStops={[
                0,
                'rgba(10, 30, 50, 0)',
                1,
            ...
            <Rect
              ...
              width={100}
              height={oceanHeight}
              fillLinearGradientStartPoint={{ x: oceanWidth - 100, y: 0 }}
              fillLinearGradientEndPoint={{ x: oceanWidth, y: 0 }}
              fillLinearGradientColorStops={[
                0,
                'rgba(10, 30, 50, 0)',
                1,
